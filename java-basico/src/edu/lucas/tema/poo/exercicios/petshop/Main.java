...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("3 - Abastecer a máquina com sahmpoo");
	...
	public static void verifyWater() {
		...
		System.out.printf("A máquina está no momento com %d litros de água", amount);
	}

	public static void verifyShampoo() {
		var amount = petMachine.getShampoo();
		System.out.printf("A máquina está no momento com %d litros de shampoo", amount);
	}
