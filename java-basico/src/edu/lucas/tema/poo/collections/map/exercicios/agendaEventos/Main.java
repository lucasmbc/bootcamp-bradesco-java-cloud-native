...
public class Main {
	...
	public static void main(String[] args) {
		...
		agendaEventos.adicionarEvento(LocalDate.of(2025, Month.MARCH, 10), "Conferência de Tecnologia",
				"Palestrante renomado");
		agendaEventos.adicionarEvento(LocalDate.of(2025, 3, 9), "Workshop de Programação",
		...
		agendaEventos.adicionarEvento(LocalDate.of(2025, 9, 20), "Seminário de Inteligência Artificial",
